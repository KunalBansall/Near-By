  ...
  return (
    ...
    ">
      <Link to={`/listing/${listing._id}`}>
        <img
          src={listing.imageUrls[0]  || "https://cdn.prod.website-files.com/620ec747459e13c7cf12a39e/625b10a58137b364b18df2ea_iStock-94179607.jpg "}
          alt="listing cover"
        ...
        <div className="p-3 flex flex-col gap-2 w-full ">
          ...
          <div className=" flex items-center gap-1">
            ...
            <p className="text-sm text-gray-600 truncate w-full">{listing.address}
            </p>
